...
bool EPEVER::getPackMeasurements() // 0x90
{
...
bool EPEVER::getMinMaxCellVoltage() // 0x91
{
...
bool EPEVER::getDischargeChargeMosStatus() // 0x93
{
...
bool EPEVER::getStatusInfo() // 0x94
{
...
bool EPEVER::getCellVoltages() // 0x95
{
    int cellNo = 0;
...
bool EPEVER::getCellTemperature() // 0x96
{
    int sensorNo = 0;
...
bool EPEVER::getCellBalanceState() // 0x97
{
    int cellBalance = 0;
    int cellBit = 0;
...
bool EPEVER::getFailureCodes() // 0x98
{
...
bool EPEVER::setDischargeMOS(bool sw) // 0xD9 0x80 First Byte 0x01=ON 0x00=OFF
{
    if (sw)
    {
#ifdef DEBUG_SERIAL
...
bool EPEVER::setChargeMOS(bool sw) // 0xDA 0x80 First Byte 0x01=ON 0x00=OFF
{
    if (sw == true)
    {
#ifdef DEBUG_SERIAL
...
bool EPEVER::setBmsReset() // 0x00 Reset the BMS
{
...
void EPEVER::sendCommand(COMMAND cmdID)
{
