...
static const char *const haDescriptor[][4]{
  ...
  {"CHARGER_MODE","","",""},
  // StatsData
  {"SOLAR_MAX","mdi:sun-angle","V","voltage"},
  {"SOLAR_MIN","mdi:sun-angle-outline","V","voltage"},
  {"BATT_MAX","mdi:battery-arrow-up-outline","V","voltage"},
  {"BATT_MIN","mdi:battery-arrow-down-outline","V","voltage"},
