...
EPEver to MQTT <a id="software_version">%SOFTWARE_VERSION%</a> By <a href="https://github.com/softwarecrash/EPEver2MQTT/" target="_blank">Softwarecrash</a>
...
<script>
    $(document).ready (function () {
        $.getJSON("https://api.github.com/repos/softwarecrash/EPEver2MQTT/releases/latest", function() {
            })
            .done (function (data) {
